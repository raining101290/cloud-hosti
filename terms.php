            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="text-center">
                        <span class="fs-18 fw-bold text-primary mb-2" data-sal="slide-up" data-sal-duration="500" data-sal-delay="300" data-sal-easing="ease-in-out-sine">Terms & Conditions</span>
                ...
                <div class="col-xl-10">
                    <div class="content-with-sidebar">
                        <div class="section-heading">
                            <h3>Welcome to CloudHosti Terms &amp; conditions</h3>
                            <p class="lead">Effective date: 1 January 2024</p>
                        </div>
                        <div id="nav-id-1" class="pt-5">
                            <p>All services provided by EyHost Ltd. may be used for lawful purposes only. Transmission, storage or presentation of any information, data or material in violation of any United States federal, state or city law and Bangladesh Govt law is prohibited. This includes, but is not limited to: copyrighted material, material we judge to be threatening or obscene, or material protected by trade secret and other statute. The subscriber agrees to indemnify and hold harmless EyHost Ltd. from any claims resulting from the use of service which damages the subscriber or any other party. Prohibited are sites that promote any illegal activity or present content that may be damaging to EyHost' servers, or any other server on the Internet. Links to such materials are also prohibited.</p>
                            <h5>Unacceptable content or links for shared hosting,windows hosting:</h5>
                            <p>This privacy policy (statement) covers all websites that are operated by EyHost. Because EyHost wants to demonstrate its commitment to our users' privacy, we have agreed to disclose our information practices.</p>
                            ...
                            <p>Nothing in the world is unlimited, and that includes server space and bandwidth. Here at EyHost, we do not keep track of how much space you are using. Clients are allowed to use as much as long as they are not crippling the servers with the amount of space, bandwidth, accounts and server resources they are using. Generally, with unlimited space and bandwidth, you will be able to use it without encountering problems but if your website is crippling the server then EyHost has the right to suspend or terminate your site with or without prior notice.</p>
                            ...
                            <p>Any attempt to undermine or cause harm to a server or customer of EyHost is strictly prohibited. As our customer you are responsible for all your accounts. Should you violate the Terms of Services outlined within, your account will be cancelled without chance of refund.</p>
                            <h5 class="mt-5 mb-5">Support</h5>
                            <p>EyHost provide provide support by ticket system and live chat. EyHost response of support ticket within 45 minutes. And maximum response time within 24 hours. Live chat is available 10 AM to 6 PM during Dhaka, Bangladesh business hours.</p>
                            <h5 class="mt-5 mb-5">Billing</h5>
                            <p>By the Account Activation Date of each month, EyHost shall either:</p> 
                            ...
                            <p>EyHost Ltd. makes no representation or warranty that the content available on this Site or the Services found at this Site are appropriate in every country or jurisdiction, and access to this Site or the Services found at this Site from countries or jurisdictions where its content is illegal is prohibited. Users who choose to access this Site or the Services found at this Site are responsible for compliance with all local laws, rules and regulations.</p>
                            <h5 class="mt-5 mb-5">Disclaimer</h5>
                            <p>EyHost cannot be held liable for system down time, crashes or data loss. We cannot be held liable for any predicated estimate of profits which a client would have gained if their site was functioning. Certain services provided by EyHost are resold. Thus, certain equipment, routing, software and programming used by EyHost are not directly owned or written by EyHost. Moreover, EyHost holds no responsibility for the use of our clients' accounts. Failure to comply with any terms or conditions will result in the automatic deactivation of the account in question. We reserve the right to remove any account, without advance notice for any reason without restitution, as EyHost sees fit.</p>
                        </div>
                    </div>
                </div>
            </div>
