...
<body>
    ...
    <div class="preloader bg-light-subtle">
        <div class="preloader-wrap">
            <img src="assets/images/cloud-host-logo-light.png" alt="logo" class="img-fluid">
    ...
    <div class="domain-list-section position-relative pb-120">
        <div class="container">
            <div class="row g-4">
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card border-0" data-sal="slide-up" data-sal-duration="300" data-sal-delay="200" data-sal-easing="ease-in-out-sine">
                        <div class="card-body price-card-item-one position-relative overflow-hidden px-xl-7 py-xl-9">
